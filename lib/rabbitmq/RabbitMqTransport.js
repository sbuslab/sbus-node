        ...
        return this._channelEstablish(
          ...
          (resp) => {
            ...
            return this.channel.consume(this.replyToQueue, (msg) => {
              ...
              if (this.promiseStorage[msg.properties.correlationId].isRejected) {
                // eslint-disable-next-line consistent-return
                return Promise.resolve(this.promiseStorage[msg.properties.correlationId].reject_ex('promise timeout')).then(() => {
